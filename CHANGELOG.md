...
### Removed
- **Departments commands** (`departments list/get`): Department management should be done via Zoho Desk web admin

### Fixed
- ViewCount and LikeCount format strings in Article output (string type)

## [0.9.2] - 2026-03-19

### Fixed
- ViewCount and LikeCount format strings in tests and output (string type)
